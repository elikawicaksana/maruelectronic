...
<head>
    ...
    <title>Maru Electronics | Product Detail</title>
        ...
        <div class="bg-neutral-primary-soft border border-default p-6 md:p-10 rounded-xl shadow-lg">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <form action="proses/prosesQuery.php" method="POST" class="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                        <input type="hidden" name="flag" value="prosesTambahKeranjang">
